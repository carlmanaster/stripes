...
const multichartStories = () => {
  ...
  const ordinalData = ['red', 'red', 'green', 'green', 'red', 'green', 'blue', 'red', 'blue', 'yellow', 'red', 'green', 'green', 'red', 'green', 'blue', 'red', 'green', 'yellow', 'red', 'blue', 'yellow', 'yellow', 'yellow', 'red', 'blue', 'red', 'blue', 'red', 'blue']
  const booleanData = [true, true, false, true, false, false, true, false, false, true, false, true, false, true, false, false, true, false, true, false, false, true, true, false, true, false, false]
  const keys = ['blue', 'green', 'red', 'yellow']
  ...
  .add('with multiple charts', () => (
    <MultiChart
      ...
      config={[{className: 'c1'}, {className: 'c2', left: 40}, {className: 'c3', left: 80, keys}]}
    />
  ))
}
