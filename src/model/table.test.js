...
describe('table', () => {
  ...
  describe('row', () => {
    it('should get row', () => {
      expect(table.row(data, standardOrder, 0)).toEqual([1, 2, 3, null, 5])
    })
    it('should get rearranged row', () => {
      expect(table.row(data, rearranged, 0)).toEqual([3, 6, null, 12, 15])
    })
  ...
  describe('substitute column', () => {
    it('should substitute column', () => {
      ...
      expect(table.column(data, standardOrder, 1)).toEqual([2, 4, 6])
    })
  })
  ...
  describe('curried', () => {
    ...
    it('should get row', () => {
      expect(r(0)).toEqual([3, 6, null, 12, 15])
    })
    it('should get column', () => {
